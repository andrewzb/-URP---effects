...
Shader "BurnFinal"
{
	Properties
	{
		...
		[ASEEnd]_alphaTreshold("alphaTreshold", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _LowestYPos;
			float _HiestYposition;
			float _FireRelativeheight;
			float _FireGap;
			float _fireDestorsionByheight;
			float _NoizeTreshhold;
			float _DisolbeGap;
			float _Smothness;
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				#ifdef _ISLOCAL_ON
				float staticSwitch269 = IN.ase_texcoord7.xyz.y;
				#else
				float staticSwitch269 = WorldPosition.y;
				#endif
				float YCoordValue272 = staticSwitch269;
				float Height147 = _FireRelativeheight;
				float lerpResult155 = lerp( _LowestYPos , _HiestYposition , Height147);
				float YHeightCoord156 = lerpResult155;
				float Gap148 = _FireGap;
				float temp_output_160_0 = ( Gap148 / 2.0 );
				float4 color277 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float4 White141 = color277;
				float4 color276 = IsGammaSpace() ? float4(0,0,0,1) : float4(0,0,0,1);
				float4 Black140 = color276;
				float4 FireMask162 = (( YCoordValue272 >= ( YHeightCoord156 - temp_output_160_0 ) && YCoordValue272 <= ( YHeightCoord156 + temp_output_160_0 ) ) ? White141 :  Black140 );
				float mulTime238 = _TimeParameters.x * 0.2;
				float2 texCoord189 = IN.ase_texcoord8.xy * float2( 1,1 ) + ( ( float2( 1,0 ) * mulTime238 ) + ( sin( _TimeParameters.x * 0.125 ) * float2( 0,1 ) ) );
				float gradientNoise190 = GradientNoise(texCoord189,_fireDestorsionByheight);
				...
				float FireHeightGap246 = ( abs( ( ( YHeightCoord156 + temp_output_203_0 ) - temp_output_206_0 ) ) / abs( ( temp_output_206_0 - YCoordValue272 ) ) );
				float temp_output_248_0 = ( FireHeightGap246 * _NoizeTreshhold );
				float DesoleBorderMask196 = step( gradientNoise190 , ( temp_output_248_0 - _DisolbeGap ) );
				float4 temp_cast_0 = (DesoleBorderMask196).xxxx;
				float4 HeightMask175 = ( YCoordValue272 > YHeightCoord156 ? Black140 : White141 );
				...
				float4 tex2DNode42 = tex2D( _BaseAlbedo, uv_BaseAlbedo );
				#ifdef _BACKFASECOLOR_ON
				float4 staticSwitch267 = _BackFaceColor;
				#else
				float4 staticSwitch267 = tex2DNode42;
				#endif
				float4 switchResult266 = (((ase_vface>0)?(tex2DNode42):(staticSwitch267)));
				float4 Albedo51 = ( DesoleCompleatMask265 == White141 ? switchResult266 : _DesolveColor );
				...
				float Occlusion = 1;
				float Alpha = FireHeightOpacityMask187.r;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				#ifdef _ISLOCAL_ON
				float staticSwitch269 = IN.ase_texcoord2.xyz.y;
				#else
				float staticSwitch269 = WorldPosition.y;
				#endif
				float YCoordValue272 = staticSwitch269;
				...
				float4 FireMask162 = (( YCoordValue272 >= ( YHeightCoord156 - temp_output_160_0 ) && YCoordValue272 <= ( YHeightCoord156 + temp_output_160_0 ) ) ? White141 :  Black140 );
				float mulTime238 = _TimeParameters.x * 0.2;
				float2 texCoord189 = IN.ase_texcoord3.xy * float2( 1,1 ) + ( ( float2( 1,0 ) * mulTime238 ) + ( sin( _TimeParameters.x * 0.125 ) * float2( 0,1 ) ) );
				float gradientNoise190 = GradientNoise(texCoord189,_fireDestorsionByheight);
				gradientNoise190 = gradientNoise190*0.5 + 0.5;
				float temp_output_203_0 = ( Gap148 / 2.0 );
				float temp_output_206_0 = ( YHeightCoord156 - temp_output_203_0 );
				...
				float temp_output_248_0 = ( FireHeightGap246 * _NoizeTreshhold );
				float OpacityMaskv2193 = step( gradientNoise190 , temp_output_248_0 );
				float4 temp_cast_0 = (OpacityMaskv2193).xxxx;
				float4 HeightMask175 = ( YCoordValue272 > YHeightCoord156 ? Black140 : White141 );
				float4 FireHeightOpacityMask187 = ( FireMask162 == White141 ? temp_cast_0 : HeightMask175 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_TARGET
			{
				...
				float4 HeightMask175 = ( YCoordValue272 > YHeightCoord156 ? Black140 : White141 );
				float4 DesoleCompleatMask265 = ( FireMask162 == White141 ? temp_cast_0 : HeightMask175 );
				float2 uv_BaseAlbedo = IN.ase_texcoord3.xy * _BaseAlbedo_ST.xy + _BaseAlbedo_ST.zw;
				float4 tex2DNode42 = tex2D( _BaseAlbedo, uv_BaseAlbedo );
				#ifdef _BACKFASECOLOR_ON
				float4 staticSwitch267 = _BackFaceColor;
				#else
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				#ifdef _ISLOCAL_ON
				float staticSwitch269 = IN.ase_texcoord3.xyz.y;
				#else
				float staticSwitch269 = WorldPosition.y;
				#endif
				float YCoordValue272 = staticSwitch269;
				...
				float4 FireMask162 = (( YCoordValue272 >= ( YHeightCoord156 - temp_output_160_0 ) && YCoordValue272 <= ( YHeightCoord156 + temp_output_160_0 ) ) ? White141 :  Black140 );
				float mulTime238 = _TimeParameters.x * 0.2;
				float2 texCoord189 = IN.ase_texcoord4.xy * float2( 1,1 ) + ( ( float2( 1,0 ) * mulTime238 ) + ( sin( _TimeParameters.x * 0.125 ) * float2( 0,1 ) ) );
				float gradientNoise190 = GradientNoise(texCoord189,_fireDestorsionByheight);
				gradientNoise190 = gradientNoise190*0.5 + 0.5;
				float temp_output_203_0 = ( Gap148 / 2.0 );
				float temp_output_206_0 = ( YHeightCoord156 - temp_output_203_0 );
...
/*ASEBEGIN
Version=18912
7;7;1920;1012;1278.52;-1614.809;1;True;True
...
Node;AmplifyShaderEditor.StaticSwitch;269;-2918.179,1401.727;Inherit;False;Property;_IsLocal;IsLocal;15;0;Create;True;0;0;0;False;0;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;276;-3150.152,1657.097;Inherit;False;Constant;_Black;Black;3;0;Create;True;0;0;0;False;0;False;0,0,0,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;277;-3144.826,1862.053;Inherit;False;Constant;_white;white;4;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;292;-448.6811,2263.244;Inherit;False;Property;_alphaTreshold;alphaTreshold;16;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;17;-447.5563,2176.728;Inherit;False;187;FireHeightOpacityMask;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;54;-365.2572,1997.99;Inherit;False;51;Albedo;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;284;-89.48416,2023.508;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;0;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;287;-89.48416,2023.508;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;285;-89.48416,2023.508;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;BurnFinal;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;38;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;0;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;0;  Use Shadow Threshold;0;Receive Shadows;0;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Write Depth;0;  Early Z;0;Vertex Position,InvertActionOnDeselection;1;0;8;False;True;False;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;289;-89.48416,2023.508;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;290;-89.48416,2023.508;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=DepthNormals;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;291;-89.48416,2023.508;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalGBuffer;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;288;-89.48416,2023.508;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;286;-89.48416,2023.508;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.CommentaryNode;257;-2189.553,2431.138;Inherit;False;1026.831;435.6214;Comment;0;fireHeightOpasityMask;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;52;-2133.421,-1145.752;Inherit;False;1126.927;867.4808;Albedo;0;Albedo;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;186;-2148.159,1873.419;Inherit;False;1026.831;435.6214;Comment;0;fireHeightOpasityMask;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;15;-2145.208,-81.23833;Inherit;False;1243.491;463.1858;Comment;0;Opacity Mask;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;283;-2173.73,2995.973;Inherit;False;1503.322;891.9609;Comment;0;Masks mexed dizolve;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;282;-2197.128,4024.294;Inherit;False;1241.854;425.3369;Comment;0;Y Miday relation poin;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;163;-2143.686,474.1425;Inherit;False;1200.457;673.5883;white - fire;0;FireMask;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;176;-2144.698,1219.349;Inherit;False;989.8214;578.5881;Black Transperant;0;Hight mask;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;281;-3206.849,1263.584;Inherit;False;710.761;1345.171;Comment;0;Props;1,1,1,1;0;0
...
WireConnection;285;0;54;0
WireConnection;285;4;6;0
WireConnection;285;6;17;0
WireConnection;285;7;292;0
ASEEND*/
//CHKSM=0859DAFB5FD7625D95AFFD6072909F046565B00E